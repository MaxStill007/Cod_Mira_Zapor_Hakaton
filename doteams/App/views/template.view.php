            ...
            <div class="my-3 mx-5 bg-white rounded shadow-md border-t-4 border-slate-300">
                <div>
                    <div class="border-b border-gray-100 flex items-center justify-between">
                        <h1 class="text-2xl p-3 text-gray-700"><?=$template['name']?></h1>
                        <!-- <div class="pr-4">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                        ...
                        <div class="grid grid-cols-2">
                            <div class="p-4">
                                <h2 class="font-bold text-md pl-3 pb-2">Навыки</h2>
                                <input
                                type="text"
                                name="skills"
                                value="<?=$template['skills'] ?? ''?>"
                                class="w-full px-4 py-2 border rounded focus:outline-none mb-4"
                                />
                            </div>
                            <div class="p-4">
                                <h2 class="font-bold text-md pl-3 pb-2">Опыт работы</h2>
                                <input
                                type="text"
                                name="experience"
                                value="<?=$template['experience'] ?? ''?>"
                                class="w-full px-4 py-2 border rounded focus:outline-none mb-4"
                                />
                            </div>
                        </div>
