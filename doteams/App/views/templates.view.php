            ...
            <div class="my-3 mx-5 bg-white rounded shadow-md border-t-4 border-slate-300">
                <div>
                    <div class="border-b border-gray-100 flex items-center justify-between">
                        <h1 class="text-2xl p-3 text-gray-700">Все шаблоны</h1>
                        <!-- <div class="pr-4">
                    ...
                    <table class="w-full">
                        <!-- <tr class="font-bold text-gray-700 border-b border-gray-100">
                            <td class="p-4">#</td> <td>Статус</td> 
                            <td>Действие</td>
                        </tr> -->
                        <!-- <a href="/tasks/<?=$template['id']?> -->
                        <?php foreach($templates as $template) : ?>
                        <div class="border-b border-gray-100 px-3 py-2">
                                <div><a href="/template/<?=$template['id']?>"><?=$template['name']?></a></div>  
                        </div>                            
                       <?php endforeach; ?>                       
                    </table>
                </div>
